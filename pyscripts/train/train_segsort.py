"""Training script for training PSPNet/ResNet-101 with SegSort."""
...
def get_arguments():
  ...
  parser = argparse.ArgumentParser(
      description='SegSort: Segmentation by Discriminative Sorting of Segments.')
  # Data parameters.
  ...
  parser.add_argument('--weight_decay', type=float, default=5e-4,
                      help='Regularization hyperparameter for L2-loss.')
...
def main():
  ...
  # Add the SegSort loss.
  seg_losses = train_utils.add_segsort_loss(
      outputs[0], labels, args.embedding_dim, args.ignore_label, 
  ...
  with tf.device('/cpu:0'):
    ...
    # Visualize first 3 channels of embeddings.
    # Can also perform PCA by calling the vis_utils.pca function.
